...
public class ReturnI32 implements ITransformer<MethodNode> {
    ...
    public Set<Target<MethodNode>> targets() {
        return Set.of(
                Target.targetMethod("mekanism.api.inventory.IInventorySlot", "getLimit", "(Lnet/minecraft/world/item/ItemStack;)I")
